...
@section('content')
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-12">
                <h2>Редактировать апартаменты: №{{ $apartment->room_number }}</h2>
                @if($apartment->photo)
                    <img src="{{ asset('storage/'.$apartment->photo) }}" alt="Апартаменты №{{ $apartment->room_number }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_price" id="name_price"
                                               ...
                                               value="{{ old('name_price', $apartment->name_price) }}" required>
                                        @error('name_price')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type" id="type"
                                               ...
                                               value="{{ old('type', $apartment->type) }}" required>
                                        @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="room_count" id="room_count"
                                               ...
                                               value="{{ old('room_count', $apartment->room_count) }}" min="1" required>
                                        @error('room_count')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="capacity" id="capacity"
                                               ...
                                               value="{{ old('capacity', $apartment->capacity) }}" min="1" required>
                                        @error('capacity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description"
                                          ...
                                          rows="4">{{ old('description', $apartment->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea name="descriptions" id="descriptions"
                                          ...
                                          rows="4">{{ old('descriptions', $apartment->descriptions) }}</textarea>
                                @error('descriptions')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea name="additional_info" id="additional_info"
                                          ...
                                          rows="4">{{ old('additional_info', $apartment->additional_info) }}</textarea>
